...
const url_file_info = "https://api.github.com/repos/Lukas-Krickl/EB-19/contents/selected.json";
var fileInfo;
var file;
var pin;
...
function uploadFile() {
  ...
  Http.setRequestHeader('Authorization', "token 46a658d44077ada248c10f44c5a8c8f9f17d4b4b");
...
function getNumber(){
  ...
  if(nr>=0){
    nrDisplay.textContent = nr+1;
    nrDisplay.classList.add("display-3");
  }
}
